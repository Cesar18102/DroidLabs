...
import nure.kyrychenko_oleh_volodymyrovych_5.Fragments.NoteFilterFragment;

import nure.kyrychenko_oleh_volodymyrovych_5.Fragments.NoteSearchFragment;
import nure.kyrychenko_oleh_volodymyrovych_5.Listeners.OnAsyncNoteQueryDoneListener;
import nure.kyrychenko_oleh_volodymyrovych_5.Listeners.OnFiltersAppliedListener;
import nure.kyrychenko_oleh_volodymyrovych_5.Listeners.OnSearchChangedListener;
...
public class MainActivity extends AppCompatActivity implements OnFiltersAppliedListener, OnSearchChangedListener, OnAsyncNoteQueryDoneListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataSource.getAllNotesAsync(null, this);
    }
    ...
    private void onCreateNoteViewContextMenu(ContextMenu menu, final NoteView noteView) {
        ...
        deleteItem.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                dataSource.deleteNote(noteView.getNote());
                return true;
            }
        });
    }
    ...
    public void onFiltersApplied() {
        ...
        dataSource.getAllNotesAsync(filterSettings, this);
    ...
    public void handleNoteQueryFinish(AsyncNoteQueryResult queryResult) {
        switch (queryResult.getQueryType()) {
            case GET:
                buildList(queryResult.getGetAllResult());
                break;
        }
